...
var _tabs = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./scripts/tabs.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

var _tabsDinamic = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./scripts/tabsDinamic.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./scripts/chain.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

var globalNavbar = new _navbar.Navbar('.global-navbar');
var categoriesNavbar = new _navbar.Navbar('.categories-navbar');
var headerCarousel = new _carousel.Carousel('.header-carousel', {
    withPager: true
});

var tabs = new _tabs.Tabs('.tabs-static');

var tabsDynamic = new _tabsDinamic.TabsDinamic('.tabs-dinamic', [{
    title: 'Tab first',
...
function topFunction() {
    var actionBtn = document.querySelector('.myBtn');
